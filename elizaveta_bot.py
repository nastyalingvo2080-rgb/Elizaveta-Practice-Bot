...
# ===== CONFIGURATION =====
BOT_TOKEN = os.environ.get('BOT_TOKEN', '8277963317:AAED-kKTLcIIJsbgbZ7utyRqyvGme5ofJHU')
REMINDER_TIME = "09:00"

# GitHub configuration - UPDATE THESE!
GITHUB_USERNAME = "nastyalingvo2080-rgb"
GITHUB_REPO = "Elizaveta-Practice-Bot"
GITHUB_BRANCH = "main"
...
@app.route('/')
def home():
    return "🤖 Elizaveta Practice Bot is running!"
